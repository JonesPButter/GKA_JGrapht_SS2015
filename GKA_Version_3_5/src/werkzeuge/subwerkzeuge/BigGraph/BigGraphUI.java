package werkzeuge.subwerkzeuge.BigGraph;
	...
	public class BigGraphUI
	{
	    final String algorithmName = "Big Graph";
	    ...
	    public BigGraphUI()
	    {
	        ...
	        JLabel kantenLabel = new JLabel("Kantenanzahl:");
	    ...
	    public JTextField getKantenanzahl()
	    {
	        return _kantenanzahl;
	    }
